  ...
  return (
    ...
    >
      ...
      <div className="relative pointer-events-none">
        ...
        {/* Main button */}
        <div className="relative flex items-center justify-center w-14 h-14 bg-green-500 rounded-full shadow-lg group-hover:bg-green-600 group-hover:scale-110 transition-all duration-300 group-hover:shadow-green-500/50 group-hover:shadow-xl">
          <svg
