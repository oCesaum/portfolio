    ...
    <>
      ...
      <div className="block lg:hidden">
        <button onClick={() => setMobileMenuIsOpen(true)}>
          <svg
            className="h-6 w-6 fill-zinc-950"
      ...
      <div
        className={`fixed right-0 top-0 z-10 h-screen w-fit shadow-lg cursor-default bg-zinc-100 px-10 py-5 transition-all duration-300 ease-in lg:hidden ${
      ...
      >
        ...
        >
          <svg
            className="h-12 w-12 fill-zinc-950 p-3 transition-transform duration-300 hover:rotate-180"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 384 512"
          >
