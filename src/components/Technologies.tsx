export default function Technologies() {
  return (
    <div className="grid grid-cols-3 sm:grid-cols-4 justify-items-center gap-5">
      <div className="w-20 h-20 sm:w-24 sm:h-24 2xl:w-36 2xl:h-36 flex flex-col justify-center items-center shadow-md shadow-zinc-950 rounded-full hover:scale-110 transition">
        <svg className="w-10 h-10 sm:w-14 sm:h-14 2xl:w-20 2xl:h-20" width={56} height={56} viewBox="0 0 128 128">
          <path
            fill="#E44D26"
