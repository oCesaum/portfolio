export default function Technologies() {
  return (
    <div className="grid grid-cols-3 justify-items-center sm:flex gap-5 justify-between mb-10">
      ...
      <div className="w-fit h-24 2xl:w-32 2xl:h-32 flex flex-col justify-center hover:scale-110 transition relative group">
        <p className="absolute -top-2 text-xs font-bold text-[#339933] hidden group-hover:block right-1/2 translate-x-1/2 uppercase">
          Node.js
        </p>
        <svg
          className="w-14 h-14 md:w-full md:h-full max-w-[60px] 2xl:w-20 2xl:h-20"
        ...
        >
          <path
            fill="#339933"
            d="M64.07 0L52.93 20.23 30.16 24.04 15.5 40.7l-4.82 22.75 10.73 21.25-10.73 21.25 4.82 22.75 14.66 16.66 22.77 3.81 11.14 20.23 11.14-20.23 22.77-3.81 14.66-16.66 4.82-22.75-10.73-21.25 10.73-21.25-4.82-22.75L75.84 24.04 53.07 20.23 64.07 0z"
          ></path>
          <path
            fill="#fff"
            d="M64.07 10.23l-6.4 11.59-12.8 2.14-14.3 14.3-2.56 12.16 8.53 16.9-8.53 16.9 2.56 12.16 14.3 14.3 12.8 2.14 6.4 11.59 6.4-11.59 12.8-2.14 14.3-14.3 2.56-12.16-8.53-16.9 8.53-16.9-2.56-12.16-14.3-14.3-12.8-2.14-6.4-11.59z"
          ></path>
          <path
            fill="#339933"
            d="M64.07 20.47l-3.2 5.8-6.4 1.07-7.15 7.15-1.28 6.08 4.27 8.45-4.27 8.45 1.28 6.08 7.15 7.15 6.4 1.07 3.2 5.8 3.2-5.8 6.4-1.07 7.15-7.15 1.28-6.08-4.27-8.45 4.27-8.45-1.28-6.08-7.15-7.15-6.4-1.07-3.2-5.8z"
          ></path>
        </svg>
      </div>
    </div>
