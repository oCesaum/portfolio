export default function Technologies() {
  return (
    <div className="sm:grid grid-cols-3 justify-items-center flex lg:flex flex-wrap gap-5 lg:gap-10 xl:gap-4 justify-between mb-10">
      ...
      <div className="w-fit h-24 2xl:w-32 2xl:h-32 flex flex-col justify-center shadow-md shadow-zinc-950 rounded-full hover:scale-110 transition relative group">
        <p className="absolute -top-2 text-xs font-bold text-[#07a9da] hidden group-hover:block right-1/2 translate-x-1/2 uppercase">Wordpress</p>
        <svg className="w-14 h-14 2xl:w-20 2xl:h-20" width={56} height={56} viewBox="0 0 128 128">
